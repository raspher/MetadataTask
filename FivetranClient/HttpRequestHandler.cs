...
public class HttpRequestHandler
{
    ...
    private static readonly TtlDictionary<string, HttpResponseMessage> ResponseCache = new();
    ...
    public HttpRequestHandler(HttpClient client, ushort maxConcurrentRequests = 0)
    {
        ...
        {
            _semaphore = new SemaphoreSlim(1, maxConcurrentRequests);
        }
    }
